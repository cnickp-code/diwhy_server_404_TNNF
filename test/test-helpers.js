...
function cleanTables(db) {
    return db.transaction(trx =>
        trx.raw(
            `
            TRUNCATE comment_likes CASCADE;
            ...
            .then(() =>
                Promise.all([
                    trx.raw(`ALTER SEQUENCE comment_likes_id_seq minvalue 0 START WITH 1`),
                    ...
                    trx.raw(`SELECT setval('comment_likes_id_seq', 0)`),
